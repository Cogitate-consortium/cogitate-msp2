...
### ACTIVATION_3RD_EXPORT_BLOCK_INSERT ###
# 07_run_3rd_level.sh inserts #SBATCH --output/--error and exports before the body runs.
...
[ -f "${FSF_FILE}" ] || preflight_fail "missing FSF file: ${FSF_FILE} (run 06_make_fsf_files_3rdlevel.sh?)"
