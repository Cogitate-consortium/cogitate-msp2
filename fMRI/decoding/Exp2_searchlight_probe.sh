#!/bin/bash
# sbatch Exp2_searchlight_probe.sh --condition=all --subject=SD176 
...
#SBATCH --output=./slurm/slurm-probe-%A_%a.out
...
python3 ../Exp2_searchlight_probe_forSlurm.py --subject "${subject}" --condition "${condition}" 