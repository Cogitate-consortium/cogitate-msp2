...
Command: python3 Exp2_searchlight_category_callSlurm.py --condition "seen-seen_nogo" --vg_or_replay "VG-Replay"
Command: python3 Exp2_searchlight_category_callSlurm.py --condition "seen_nogo-seen" --vg_or_replay "Replay-VG"
Command: python3 Exp2_searchlight_category_callSlurm.py --condition "seen_nogo" --vg_or_replay "Replay"
Command: python3 Exp2_searchlight_category_callSlurm.py --condition "seen_go" --vg_or_replay "Replay"
Command: python3 Exp2_searchlight_category_callSlurm.py --condition "seen" --vg_or_replay "Replay"
"""
...
analysis_check_data = csv_data.DECODING_min_sf_so # generalization of category decoding
...
def run_analysis():
    ...
    parser.add_argument('--vg_or_replay', type=str, default=None,
                        help="VG, Replay, VG-Replay, Replay-Replay, VG_VG, etc.")
    ...
    for sub_code, analysis_check in zip(subject_list, analysis_check_list):
        ...
        if analysis_check:
            #slurm command
            run_command = f"sbatch Exp2_searchlight_category.sh --subject={sub_code} --condition={condition} --vg_or_replay={vg_or_replay}"
