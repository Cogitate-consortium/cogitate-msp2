#!/bin/bash
# sbatch Exp2_searchlight_RSA_Replay_category.sh --subject=SD201 
...
#SBATCH --time 2:00:00
#SBATCH --output=./slurm/slurm-RSAreplayCat-%A_%a.out
#SBATCH --job-name=RSArepCat
...
python3 ../Exp2_searchlight_RSA_Replay_category_forSlurm.py --subject "${subject}"