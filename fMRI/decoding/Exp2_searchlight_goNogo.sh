#!/bin/bash
# sbatch Exp2_searchlight_goNogo.sh --subject=SD176 
...
#SBATCH --output=./slurm/slurm-goNogo-%A_%a.out
#SBATCH --job-name=goNogo
...
python3 ../Exp2_searchlight_goNogo_forSlurm.py --subject "${subject}"