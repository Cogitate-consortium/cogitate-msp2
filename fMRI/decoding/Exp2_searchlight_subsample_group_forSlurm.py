...
Condition: seen or unseen
Command: python3 Exp2_searchlight_subsample_group_forSlurm.py --decoding_problem "${decoding_problem}" --condition "${condition}"
"""
...
def run_analysis():
    ...
    for sub_code, analysis_check in zip(subject_list, analysis_check_list):
        ...
        if analysis_check:
            sub = 'sub-' + sub_code
            output_filename = 'searchlight_' + sub + '_' + vg_or_replay + '_' + decoding_problem + '_' + condition + '_' + approach + '_' + str(
    ...
    output_filename = 'searchlight_group_' + vg_or_replay + '_' + decoding_problem + '_' + condition + '_' + approach + str(
        num_iter) + 'subsample'
