...
Command: python3 Exp2_searchlight_category_subsample_callSlurm.py --condition "seen"
"""
...
# use code for comparing category decoding in seen vs. unseen:
...
def run_analysis():
    ...
    for sub_code, analysis_check in zip(subject_list, analysis_check_list):
        ...
        if analysis_check == True:
            #slurm command
            run_command = f"sbatch Exp2_searchlight_category_subsample.sh --subject={sub_code} --condition={condition}"
