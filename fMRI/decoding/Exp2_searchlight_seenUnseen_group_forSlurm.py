...
Command: python3 Exp2_searchlight_seenUnseen_group_forSlurm.py
"""
...
def run_analysis():
    ...
    print('using subject code: DECODING_min_sl_sr_ul_ur')
    # Loop over subjects
    # Output path
    ...
    output_filename = 'searchlight_seenUnseen_group_' + vg_or_replay
