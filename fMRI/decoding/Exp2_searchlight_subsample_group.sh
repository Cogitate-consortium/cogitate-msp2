...
#SBATCH --output=./slurm/slurm-srchlit-sample-group-%A_%a.out
#SBATCH --job-name=groupSmp
...
python3 ../Exp2_searchlight_subsample_group_forSlurm.py --decoding_problem "${decoding_problem}" --condition "${condition}"