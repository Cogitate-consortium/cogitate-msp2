...
Condition: all, seen or unseen.
Command: python3 Exp2_searchlight_probe_group_forSlurm.py --condition "${condition}"
"""
...
def run_analysis():
    ...
    # csv_data.DECODING_min_sf_so
    # csv_data.DECODING_min_sf_so_uf_uo
    # csv_data.DECODING_min_sl_sr
    # csv_data.DECODING_min_sl_sr_ul_ur
    ...
    for sub_code, analysis_check in zip(subject_list, analysis_check_list):
        if analysis_check:
            ...
            if os.path.exists(searchlight_path):
                ...
                print('MISSING SUB: ' + sub + ': ' + searchlight_path)

                missing_subjects.append(sub_code)
        else:
            print('excluding sub: ' + sub_code)
    ...
    output_filename = 'searchlight_probe_group_' + condition
