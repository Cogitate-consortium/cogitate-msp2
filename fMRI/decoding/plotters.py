...
from mne.surface import read_curvature, mesh_edges # instead of _mesh_borders
...
def plot_brain(subject='fsaverage', subjects_dir=None, surface='inflated', hemi='lh', sulc_map='curv',
               ...
               cmap='Oranges', colorbar=True, colorbar_title=None, colorbar_title_position='top', cmap_start=0.1,
               cmap_end=1.,
    ...
    if roi_map is not None:
        ...
        for i, roi in enumerate(roi_map):
            ...
            if roi_map_edge_color is not None:
                ...
                keep_idx = mesh_edges(faces, scalars) # instead of _mesh_borders
    ...
    if colorbar:
        ...
        cb.ax.yaxis.set_major_formatter(
            ticker.FuncFormatter(lambda val, pos: '{:.0f}'.format(val * 100))
        )
