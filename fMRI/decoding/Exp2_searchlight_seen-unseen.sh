...
# sbatch Exp2_searchlight_seen-unseen.sh --decoding_problem=category
...
#SBATCH --output=./slurm/slurm-seen-unseen-%A_%a.out
#SBATCH --job-name=snUnsn
...
python3 ../Exp2_searchlight_seen-unseen_forSlurm.py --decoding_problem "${decoding_problem}"