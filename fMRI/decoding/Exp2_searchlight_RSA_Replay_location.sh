#!/bin/bash
# sbatch Exp2_searchlight_RSA_Replay_location.sh --subject=SD201 
...
#SBATCH --time 2:00:00
#SBATCH --output=./slurm/slurm-RSAreplayLoc-%A_%a.out
#SBATCH --job-name=RSArepLoc
...
python3 ../Exp2_searchlight_RSA_Replay_location_forSlurm.py --subject "${subject}"