...
def Loc_dAT(epochs,score_methods,fname_fig_wcd,fname_fig_ctwcd):
    ...
    y = temp
    X=epochT.copy().pick_types(eog=True).get_data()
...
if __name__ == "__main__":
    ...
    analysis_name='Sensor_dAT_EOG_loc'
    ...
    fname_fig_wcd = op.join(dAT_figure_root, 
                            sub_info  
                            + "_acc_dAT_loc_wcd" + '.png')
    
    fname_fig_ctwcd = op.join(dAT_figure_root, 
                            sub_info  
                            + "_acc_dAT_loc_ctwcd" + '.png')
    ...
    dAT_wcd,dAT_ctwcd= Loc_dAT(epochs,score_methods,fname_fig_wcd,fname_fig_ctwcd)
    ...
    fname_data=op.join(dAT_data_root, sub_info + '_' + task +"_dAT_loc_acc" + '.pickle')
