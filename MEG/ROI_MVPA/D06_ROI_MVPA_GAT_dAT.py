...
if __name__ == "__main__":
    ...
    analysis_name='GAT_PFC_dAT_full'
    task_info='vg'
    ...
    for nroi, roi_name in enumerate(ROI_Name):
        ...
        fname_fig_acc = op.join(roi_figure_root, 
                            sub_info  + 'Cat' + '_' + roi_name + "_acc_CTWCD" + '.png')
