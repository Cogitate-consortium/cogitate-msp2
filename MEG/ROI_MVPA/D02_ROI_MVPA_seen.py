...
def Category_WCD(epochs_rs,stcs,
 ...
 #                nPCA,
    ...
    #for condi in range(2):
        #con_index=np.where(epochs_rs.metadata['Stimuli_type'] == condition_Stim[condi])[0]
        #group_x=X[con_index]
        #group_y=y[con_index]
...
if __name__ == "__main__":
    ...
    analysis_name='seen_subPFC_full'
    task_info='vg'
