...
from D_MEG_function_E2 import set_path_ROI_MVPA, ATdata,sensor_data_for_ROI_MVPA_dAT,get_lables
...
if __name__ == "__main__":
    ...
    analysis_name='dAT_subP2F_loc_full'
    task_info='vg'
