...
def Loc_CT(epochs1,epochs2,score_methods,fname_fig_ccd,fname_fig_ctccd):
    ...
    temp1[epochT1.metadata['Location'] == condition_Stim[0]] = 1  # right
    temp1[epochT1.metadata['Location'] == condition_Stim[1]] = 1 # right
    temp1[epochT1.metadata['Location'] == condition_Stim[2]] = 2  # left
    temp1[epochT1.metadata['Location'] == condition_Stim[3]] = 2 # left
    ...
    temp2[epochT2.metadata['Location'] == condition_Stim[0]] = 1  # right
    temp2[epochT2.metadata['Location'] == condition_Stim[1]] = 1 # right
    temp2[epochT2.metadata['Location'] == condition_Stim[2]] = 2  # left
    temp2[epochT2.metadata['Location'] == condition_Stim[3]] = 2 # left
...
if __name__ == "__main__":
    ...
    analysis_name='Sensor_CrossTask_loc'
    ...
    fname_fig_ccd = op.join(dAT_figure_root, 
                            sub_info  
                            + "_acc_sensor_loc_ccd" + '.png')
    
    fname_fig_ctccd = op.join(dAT_figure_root, 
                            sub_info  
                            + "_acc_sensor_loc_ctccd" + '.png')
    ...
    CT_ccd,CT_ctccd= Loc_CT(epochs1,epochs2,score_methods,fname_fig_ccd,fname_fig_ctccd)
    ...
    fname_data=op.join(dAT_data_root, sub_info +"_sensor_CrossTask_Loc_acc" + '.pickle')
