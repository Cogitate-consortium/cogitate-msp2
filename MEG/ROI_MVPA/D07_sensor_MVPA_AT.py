...
def Cat_AT(epochs,score_methods,fname_fig_wcd,fname_fig_ctwcd):
...
if __name__ == "__main__":
    ...
    AT_wcd,AT_ctwcd= Cat_AT(epochs,score_methods,fname_fig_wcd,fname_fig_ctwcd)
    ...
    fname_data=op.join(AT_data_root, sub_info + '_' + task +"_AT_Cat_acc" + '.pickle')
