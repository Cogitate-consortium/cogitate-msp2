'''
Plot of the group-level VertROI source-ERF analysis (cond1 vs cond2 across VertROI labels).
Run first: pipeline_erf_VertROI.py (individual) then pipeline_erf_VertROI_group.py (group CBPT).
...
Config folder: /config_files/pipeline_erf_VertROI_group_IIT_baseline/
    T_mean_V_rms_subsamp_baseline_vertFFstiVbla.json
'''
...
if   flag_test:
    ...
    args.group_ana = 'pipeline_erf_VertROI_group_plot'
    args.group_configfolder = 'pipeline_erf_VertROI_group_IIT_baseline'
    args.group_configfile = base / "config_files" / "pipeline_erf_VertROI_group_IIT_baseline" / "T_mean_V_rms_subsamp_baseline_vertFFstiVbla.json"

    
    args.individual_ana = 'pipeline_erf_VertROI'
    args.individual_configfolder = 'pipeline_erf_VertROI'
    args.individual_configfile      = base / "config_files" / "pipeline_erf_VertROI" / "dAT_probe_stim_ft_nobc_deci1_nocut.json"
    ...
    parser.add_argument('--group_configfile', type=str, default=None,
                        help="configfile file for group analysis param_subeters (file name + path)")
    parser.add_argument('--individual_configfile', type=str, default=None,
                        help="configfile file for individual analysis param_subeters (file name + path)")
