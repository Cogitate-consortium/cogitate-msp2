...
single frequency band, for one vertex-ROI, on the source-space TFR power computed
by pipeline_tfr_VertROI.py. Same as pipeline_tfr_source_group_band.py but on the
IIT-selected vertex-ROIs (VertROI_params_dict; stimulus vs blank baseline).
...
if   flag_test:
    ...
    args.group_configfolder = 'pipeline_tfr_VertROI_group_band_baseline'
    args.group_configfile = base / "config_files" / "pipeline_tfr_VertROI_group_band_baseline" / "higher_gamma_pre500_0.json"
