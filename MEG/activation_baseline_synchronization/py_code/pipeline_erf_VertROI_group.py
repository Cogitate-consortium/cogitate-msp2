'''
Group-level source-ERF statistics for the VertROIs, comparing cond1 vs cond2
(consumes pipeline_erf_VertROI.py output).
...
if   flag_test:
    ...
    args.group_ana = 'pipeline_erf_VertROI_group'
...
roi_param_subs = general_param['VertROI_params_dict']
