...
'''
Group-level statistics on the PPC results (GNW: FF category-selective GED vs PFC GED).
...
pipeline_syn_subsampling_ppc_GED_ROI.py, then runs the group statistics.

Individual results are read from  path_allana / <individual_ana> / <epoch_info>.
--individual_ana must be pipeline_syn_subsampling_ppc_GED_ROI
...
Config folder: /config_files/pipeline_syn_ppc_GED_ROI_group_250_500/ (NOrm used)
...
if   flag_test:
    ...
    args.group_ana = 'pipeline_syn_ppc_GED_ROI_group'
    args.group_configfolder = 'pipeline_syn_ppc_GED_ROI_group_250_500'
    args.group_configfile = base / "config_files" / "pipeline_syn_ppc_GED_ROI_group_250_500" / "NOrm_FFface_PFCact_preferface_250_500.json"

    
    args.individual_ana = 'pipeline_syn_subsampling_ppc_GED_ROI'
    args.individual_configfolder = 'pipeline_syn_subsampling_ppc_GED_ROI'
    args.individual_configfile      = base / "config_files" / "pipeline_syn_subsampling_ppc_GED_ROI" / "noft_nobc_deci1_nocut_allseen.json"
